...
namespace HSPE
{
    public class ManualBoneController : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            this._tabFunctions.Add(SelectedTab.BlendShapes, this.BlendShapes);
            ...
            this._purpleMat = new Material(Shader.Find("Unlit/Color")) { color = Color.magenta };
        ...
        {
            if (this.drawAdvancedMode == false)
                return;
            ...
            switch (this._selectedTab)
            {
                ...
                case SelectedTab.DynamicBonesEditor:
                    for (int i = 0; i < this._dynamicBones.Count; i++)
                    {
                        ...
                        GL.Begin(GL.LINES);
                        if (db == this._dynamicBoneTarget)
                            this._purpleMat.SetPass(0);
                        else
                            this._colliderMat.SetPass(0);
                        this.DrawVector(origin, final);
                        GL.End();
        ...
        private IEnumerator LoadDefaultVersion_Routine(XmlNode xmlNode)
        {
            ...
            yield return null;
            yield return null;
            UnityEngine.Debug.Log("test " + this.chara.charInfo.customInfo.name);
