...
namespace HSUS
{
    public static class GenericFK
    {
        ...
        public static class AddObjectItem_Load_Patches
        {
            private static Type _itemFKCtrl;
            public static bool Prepare()
            {
                _itemFKCtrl = Type.GetType("Studio.ItemFKCtrl,Assembly-CSharp");
                return HSUS._self._enableGenericFK && HSUS._self._binary == HSUS.Binary.Neo && _itemFKCtrl != null;
            }
        ...
        public static class ItemFKCtrl_InitBone_Patches
        {
            ...
            {
                if (HSUS._self._binary == HSUS.Binary.Neo && HSUS._self._enableGenericFK && Type.GetType("Studio.ItemFKCtrl,Assembly-CSharp") != null)
                {
