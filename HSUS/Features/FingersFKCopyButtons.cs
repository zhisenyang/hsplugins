...
namespace HSUS
{
    public static class FingersFKCopyButtons
    {
        public static void Do()
        {
            ...
            b.onClick.AddListener(() =>
            {
                ...
                if (selected == null)
                    return;
                CopyToFKBoneOfGroup(selected.listBones, OIBoneInfo.BoneGroup.LeftHand);
            });
        ...
        private static void CopyToFKBoneOfGroup(List<OCIChar.BoneInfo> listBones, OIBoneInfo.BoneGroup group)
        {
